  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex transition-colors duration-500 relative">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
        ...
        <div
          className="absolute top-0 left-0 w-full h-[2px] animate-scan pointer-events-none"
          style={{ background: 'linear-gradient(to right, transparent, color-mix(in srgb, var(--kais-primary) 25%, transparent), transparent)' }}
        />
      </div>
