                         ...
                         <form onSubmit={handleSubmit} className="space-y-6">
                              ...
                              <div className="pt-6 border-t border-slate-100 dark:border-slate-800 flex justify-end">
                                   <button
                                        ...
                                        className="flex items-center gap-2  import React, { useState } from 'react';
import { Mail, MessageSquare, Send, Paperclip, AlertCircle, CheckCircle2, X } from 'lucide-react';
import { useAuth } from '../context/AuthContext';
                         ...
                         <form onSubmit={handleSubmit} className="space-y-6">
                              ...
                              <div className="pt-6 border-t border-slate-100 dark:border-slate-800 flex justify-end">
                                   <button
                                        type="submit"
                                        disabled={isSubmitting}
                                        className="flex items-center gap-2 bg-blue-600 hover:bg-blue-500 text-white px-8 py-3.5 rounded-2xl text-sm font-semibold shadow-lg  transition-all focus:ring-4 focus:ring-blue-100 dark:focus:ring-blue-900/30 disabled:opacity-50 disabled:cursor-not-allowed"
                                   >
                                        {isSubmitting ? (
