                              ...
                              {isTyping && (
                                   <div className="flex justify-start animate-in slide-in-from-bottom-2">
                                        ...
                                        <div className="bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-3xl rounded-tl-sm shadow-sm p-5 flex items-center gap-2">
                                             <span className="relative inline-flex rounded-full h-3 w-3 bg-orange animate-pulse [animation-delay:-0.3s]"></span>
                                             <span className="relative inline-flex rounded-full h-3 w-3 bg-orange animate-pulse [animation-delay:-0.15s]"></span>
                                             <span className="relative inline-flex rounded-full h-3 w-3 bg-orange animate-pulse"></span>
                                        </div>
                                   </div>
                              )}
                              <div ref={chatEndRef} />
